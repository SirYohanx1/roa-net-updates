  ...
  try {
    ...
    const config = {
      ...
      "inbounds": [{
        ...
        "auto_route": true,
        "strict_route": false,
        // ✅ Safe Mode: "පරණ ලෙඩේ" නොවෙන්න මේක false කළා
        "stack": "system",
        "mtu": 1280,
        "sniff": true
      }],
      "outbounds": [
        {
          ...
          "transport": params.get("type") === "ws" ? { "type": "ws", "path": pathVal, "headers": { "Host": host } } : void 0
        },
...
ipcMain.on("start-tunnel", (event, data) => {
  ...
  if (!generateSingboxConfig(vlessLink)) {
    event.reply("xray-log", "Error: Invalid Link!");
    return;
  }
  cleanUpProcesses(() => {
...
ipcMain.on("stop-tunnel", (event) => {
  cleanUpProcesses(() => {
    sbProcess = null;
    event.reply("xray-log", "Disconnected.");
  });
});
...
ipcMain.on("minimize-app", () => {
  var _a;
  return (_a = BrowserWindow.getFocusedWindow()) == null ? void 0 : _a.minimize();
});
